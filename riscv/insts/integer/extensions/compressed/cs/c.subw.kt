...
val csubw = CSTypeInstruction(
        ...
        funct = 0b11,
        funct6 = 0b100011,
        eval16 = { a, b -> throw InstructionNotSupportedError("c.subw is not supported on 16 bit systems!") },
        eval32 = { a, b -> throw InstructionNotSupportedError("c.subw is not supported on 32 bit systems!") },
